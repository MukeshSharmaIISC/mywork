...
public class DebugDataCollector {
    ...
    public static void handleDebugXValue(Object xValue, Map<String, String> variables) {
        try {
            ...
            // If this is a NodeDescriptorProvider, prefer the descriptor (works for many IDEs)
            Object valObj = xValue;
            if (xValue instanceof NodeDescriptorProvider) {
                valObj = ((NodeDescriptorProvider) xValue).getDescriptor();
            }
            ...
            // IntelliJ ValueDescriptorImpl fallback
            if (valObj instanceof ValueDescriptorImpl) {
                ValueDescriptorImpl vd = (ValueDescriptorImpl) valObj;
                try {
                    String name = vd.getName();
                    String value = vd.calcValueName();
